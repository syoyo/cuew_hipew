...
typedef enum cufftResult_t cufftResult; // id 0x560c8dc03c78 

typedef float cufftReal; // id 0x560c8dc03d00 

typedef double cufftDoubleReal; // id 0x560c8dc03d70 

typedef cuComplex cufftComplex; // id 0x560c8dc03dd8 

typedef cuDoubleComplex cufftDoubleComplex; // id 0x560c8dc03e40 
...
typedef enum cufftType_t cufftType; // id 0x560c8dc04318 
...
typedef enum cufftCompatibility_t cufftCompatibility; // id 0x560c8dc04538 

typedef int cufftHandle; // id 0x560c8dc045c0 
...
extern int cuewInitCUFFT(const char **extra_dll_search_paths);
